...
Toggle with TRACE_ENV=1 env var.  When disabled (the default) every trace
...
from cute_utils import ParamsBase, store, store_v2


# ---------------------------------------------------------------------------
# Constants
# ---------------------------------------------------------------------------
TRACE_ENV = "CUTEDSL_TRACE"
...
def enabled() -> bool:
    """Check CUTEDSL_TRACE=1.  Evaluated at JIT time so disabled = no codegen."""
